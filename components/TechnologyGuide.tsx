    ...
    <section className="py-16">
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Understanding OLED vs QLED vs Mini-LED</p>
        </div>
        
        {/* Technology Timeline */}
        <div className="bg-gray-50 rounded-2xl p-8 mb-12">
          <h3 className="text-2xl font-bold text-center mb-8">Display Technology Evolution</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-center py-3 px-4">Key Strength</th>
                </tr>
              </thead>
              <tbody>
                {technologies.slice(0, 5).map((tech) => (
                  <tr key={tech.id} className="border-b hover:bg-gray-50">
                    <td className="py-3 px-4 font-semibold">{tech.name}</td>
                    <td className="py-3 px-4 text-center text-sm">{tech.bestFor}</td>
                    <td className="py-3 px-4 text-center font-semibold">
                      ${tech.priceRange.min} - ${tech.priceRange.max}+
                    </td>
                    <td className="py-3 px-4 text-center text-sm">{tech.pros[0]}</td>
                  </tr>
                ))}
              </tbody>
            </table>
